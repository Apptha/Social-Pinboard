...
class socialpinboardViewmanageboard extends SocialpinboardView
{
     protected $canDo;
    function display($tpl=NULL)
    {
        ...
        {
            JToolBarHelper::title('Social Pinboard Manage Board', 'manage-boards.png');
            ...
            $getPinboard = $model->getPinboard();

            $status_value = $getPinboard['status_value'];
            if($status_value != '3'){
            ...
            $this->assignRef('getPinboard', $getPinboard);
            parent::display();
        }
