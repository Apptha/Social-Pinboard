 ...
 * @abstract      : Social Pinboard Component popular controller file
...
class socialpinboardControllerpopular extends SocialpinboardController {

    function display($cachable = false, $urlparams = false) {

        $app = JFactory::getApplication();

        JRequest::setVar('view', 'popular');
