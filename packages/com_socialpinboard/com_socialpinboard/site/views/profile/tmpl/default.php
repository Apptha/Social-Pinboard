...
<?php echo JText::_('COM_SOCIALPINBOARD_ABOUT'); ?>
                    ...
                    <div class="edit_input">
                        <textarea name="about" onKeyDown="CountLeft(this.form.about,this.form.left,200);"
                                  onKeyUp="CountLeft(this.form.about,this.form.left,200);" style="float: left; min-width: 375px;"><?php echo $profileDetails[0]->about; ?></textarea>
                        <div class="floatleft">Remaining Characters:</div><div class="commenttxt"><input readonly type="text" name="left" size=1 maxlength=8 value="200" style="border:none;background:none;width:70px;" /></div>
                    </div>
...
?>
                ...
                <li class="Delete">
                    <label>&nbsp;</label>
                    <div class="Right">
                        <a href="#" id="delete_user_account" class="Button WhiteButton Button18" name="delete_user_account"><strong>
<?php echo JText::_('COM_SOCIALPINBOARD_DELETE_ACCOUNT'); ?></strong><span></span></a>
                        <div id="DeleteForm">                        
                            <p>
                                <span><?php echo JTEXT::_('COM_SOCIALPINBOARD_ACCOUNT_DELETE_SORRY_TO_COME'); ?></span>
<?php echo JTEXT::_('COM_SOCIALPINBOARD_ACCOUNT_DELETE_ALERTS'); ?></p>
                            ...
                            <a href="#" id="ChangeOfHeart"><?php echo JTEXT::_('COM_SOCIALPINBOARD_ACCOUNT_HAVE_CHANGED_MY_MIND'); ?></a>
                        </div>
                    </div>                    
                </li>
            </ul>
