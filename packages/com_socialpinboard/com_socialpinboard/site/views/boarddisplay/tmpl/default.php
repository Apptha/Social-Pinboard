...
<?php } ?>
                                <div>
                                    <a class="new-img" href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boardpage&bId=' . $board->board_id) ?>">
                                        <h3 class="board-title"><?php echo $board->board_name; ?></h3>
                                    </a>
                <?php
            ...
            <?php if (($board->cuser_id) && ($user->id == $board->cuser_id )) {
 ?>
     ...
     <script>
         ...
         scr(document).ready(function($) {
             ...
             $container.infinitescroll({
                 ...
                 // extraScrollPx: 500,
                 loading: {
                     msgText:"<em>Loading the next set of Boards...</em>",
                     finishedMsg: 'No more Boards to load.',
