...
$document->addStyleSheet('components' . DS . 'com_socialpinboard' . DS . 'css' . DS . 'invite_frnds.css');
$document->addStyleSheet('components' . DS . 'com_socialpinboard' . DS . 'css' . DS . 'pinboard.css');
$document->addStyleSheet('components' . DS . 'com_socialpinboard' . DS . 'css' . DS . 'style.css');
...
?> 
        <div class="invite_frnds_facebook">
            ...
            <a style="width:500px;" href="<?php echo $loginUrl; ?>"><strong><?php echo JText::_('COM_SOCIALPINBOARD_FIND_FRIENDS_FROM_FACEBOOK') ?></strong><img src ="<?php echo JURI::base(); ?>components/com_socialpinboard/images/facebookinvitebtn.png" alt="<?php echo JText::_('COM_SOCIALPINBOARD_FACEBOOK_LOGIN') ?>"/></a>
        </div>
