...
<div class="invite_frnds">
    ...
    ?>
                <a href="<?php echo $auth_url; ?>" id="yloginLink"><img src="<?php echo JURI::base() . '/components/com_socialpinboard/images/yahoo-btn.png'; ?>" style="margin-left: 210px;" title="Find Friends from Yahoo" alt="Find Friends from Yahoo" /></a>
    <?php
