...
<?php if (!JRequest::getVar('page')) { ?>
        <div class="CloseupLeft" style="float: left;">
            <div class="pin pinBoard WhiteContainer clearfix" id="sideboard">
...
?>
        ...
        <?php
            ...
            <div class="WhiteContainer user_board " style="">
...
<?php if ($user_id != $pinDetails->pin_user_id) { ?>
                                        <div class="btn-pinlist btn-like" id="likebtn<?php echo $pin_id; ?>">
                                            <input type="button" class="pin_like" onclick="getlike(<?php echo $pin_id; ?>,<?php echo $userids; ?>,<?php echo $flag = 0; ?>)" title="like" id="like-<?php echo $pin_id; ?>" style="<?php echo $likestyle; ?>" value="<?php echo JText::_('COM_SOCIALPINBOARD_LIKE'); ?>" />
                                            <input type="button" class="pin_unlike" onclick="getlike(<?php echo $pin_id; ?>,<?php echo $userids; ?>,<?php echo $flag = 1; ?>)" title="unlike" id="unlike-<?php echo $pin_id; ?>" style="<?php echo $unlikestyle; ?>" value="<?php echo JText::_('COM_SOCIALPINBOARD_UNLIKE'); ?>" />
                                        </div>
                <?php
                                }
                ?>
...
?>
                    ...
                    ?>
                                    <div id="PinImageHolder">
                                        <iframe width="585" height="415" src="http://www.youtube-nocookie.com/embed/<?php echo $youtube; ?>?autohide=1&amp;theme=light&amp;hd=1&amp;modestbranding=1&amp;rel=0&amp;showinfo=0&amp;showsearch=0&amp;wmode=transparent&amp;autoplay=1" frameborder="0" allowfullscreen=""></iframe>
                                    </div>
                    <?php
                                } elseif ($pinDetails->link_type == 'vimeo') {
                    ?>
                                    <div id="PinImageHolder">
                                        <iframe src="http://player.vimeo.com/video/<?php echo $youtube; ?>" width="585" height="415" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                                    </div>
                    <?php
                                } else {
                    ?>
...
<?php
                                if (!empty($bottomad)) {
?>
                                <div id="bottomad" style="margin: 0 auto; width: 470px;">
...
?>
                ...
                ?>
                                                    ...
                                                    <div class="pin_board_user_right">
                                                        ...
                                                        <span class="board_comment-text"><?php echo $comment->pin_comment_text ?></span>
                <?php
...
<?php if ($user_id != 0) { ?>
                         ...
                         <input type="button" name="post_comment" id="post_comment" style="display:none;"
                                class="button" onclick="doHomeComment(<?php echo $pinDetails->pin_id; ?>,'<?php echo $user_res1->first_name; ?>','<?php echo $user_res1->last_name; ?>','<?php echo $user_res1->user_image; ?>','<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boarddisplay&uid=' . $user->id); ?>','<?php echo $pinDetails->pin_user_id; ?>')" value="<?php echo JText::_('COM_SOCIALPINBOARD_COMMENT'); ?>" />
...
?>
                                                 <li> <img src="<?php echo $src_path; ?>" alt="" width="49" height="49" /></li>
<?php }
                                         } ?>
...
?>
                                 <div class="pinned_via">
                                     pinned via <a target="_blank" class="by_link" href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pinit'); ?>">Pin IT Button </a><span class="from_text"><?php echo "from"; ?></span>
                                     <a target="_blank" class="by_name" href="<?php echo $url ?>"><?php echo $url ?></a></span>
                                     <ul id="BoardThumbs">
                    <?php
                                     //addedby powya
...
?>
 ...
 ?>
                ...
                ?>
                         <div id="SocialShare">
                <?php
                                 $pageURl = JURI::base() . JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $pin_id);
                ?>
                <?php
                ...
                <?php if ($user_id != 0) {
 ?>
                                     <li><a id="PinReport" class="Button WhiteButton Button11" onclick="Modal.show('report');"><strong><?php echo JText::_('COM_SOCIALPINBOARD_REPORT_PIN'); ?></strong></a></li>
                 ...
                 <script type="text/javascript">
                     ...
                     function sendemail()
                     {
                         ...
                         xmlhttp.open("POST","<?php echo JRoute::_('index.php?option=com_socialpinboard&view=emailshare&tmpl=component'); ?>",true);
                                     ...
                                     function doHomeComment(pinId,firstName,lastName,userImage,userUrl,pin_user_id) {
                                             ...
                                             scr.ajax({
                                                 ...
                                                 success:function(message) {
                                                     ...
                                                     if(message != "error") {
                                                         ...
                                                         {
                                                             message1+='<span class="board_comment-text">'+message+'</span>'
                                                         }
                                     ...
                                     function getlike(pinId,userId,pinFlag)
                                     {
...
?>
                                             embedc+= "&nbsp; Source :&nbsp; <a style='text-decoration: underline; font-size: 13px; color: #000;' href='<?php echo $pinDetails->pin_url; ?>' target=_blank><?php echo $pin_url; ?></a>&nbsp;";
                                             embedc+= "via";
