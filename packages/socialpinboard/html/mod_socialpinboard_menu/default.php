...
$id = $user->id;
$show_request1 = $show_request->setting_show_request;
$show_register_btn = $show_request->setting_user_registration;
$app = JFactory::getApplication();
$document = JFactory::getDocument();
$document->addStyleSheet('templates/socialpinboard/html/mod_socialpinboard_menu/css/socialpinboard_menu.css');
...
$document->addStyleSheet('templates/socialpinboard/html/com_socialpinboard/css/main.css');
$document->addStyleSheet('templates/socialpinboard/html/com_socialpinboard/css/customSelectBox.css');
$document->addStyleSheet('templates/socialpinboard/html/com_socialpinboard/css/jquery.jscrollpane.css');
...
bodyTag.className = "hasJS";
var enter_board_name = "<?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_ENTER_NEW_BOARD_NAME'); ?>";
var board_name_exist = "<?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_BOARD_NAME_EXIST'); ?>";
</script>
<div id="social_menu">
 ...
 ?>
            ...
            <li class="top_headermenu_link">
                <a class="link_active" id="addPlus" onclick="addplus_popup(); Modal.show('Add'); return false" href="#" >
...
<?php } ?>
        <li style="cursor: pointer;" id="aboutMob"  class="top_headermenu_link about_title"> <a href="#" class="nav about link_active "><?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_ABOUT') ?><span></span></a>
            <ul>
                <?php
                $field = 'title,link';
        ...
        <?php
                if (!$user->id && $show_request1 == 0 && $show_register_btn ==1) {
        ?>
                    <li class="customer_grid top_headermenu_link">
                        <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=register'); ?>" class="nav link_active">
                        <?php echo JText::_('MOD_SOCIALPINBOARD_REGISTER'); ?>
                        </a>
                    </li>
        <?php
                } else {
                    if (!$user->id && $show_request1 == 1) {
        ?>

                        <li class="customer_grid top_headermenu_link"><a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=inviterequest'); ?>" class="nav link_active"><?php echo JText::_('MOD_SOCAILPINBOARD_INVITE'); ?></a></li>
<?php
                    }
                }
?>

                <li class="customer_grid top_headermenu_link" style="cursor: pointer;">
<?php if ($id != 0) { ?>
                        <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boarddisplay') ?>" class="nav link_active LoginNav">
<?php
...
?>
                ...
                <ul class="pin-login-drop">
                    ...
                    <li><a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pindisplay') ?>"><?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_PINS') ?></a></li>
                    ...
                    <li class="divider"><a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=profile') ?>"><?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_SETTINGS') ?></a></li>
                                    ...
                                    <ul class="Form FancyForm">
                                        <li>
                                            ...
                                            <div id="urlImages" style="display:none;">
                                                ...
                                                <div id="getimg_desc">
                                                    <select name="pin_board" id="pin_board" class="custom customStyleSelectBox" >
                                        <?php foreach ($resultboards as $boards) {
 ?>
                                            <option value="<?php echo $boards->board_id; ?>" <?php if (!empty($boards->cuser_id)) { ?>
                                    class="edit-board_cont"
                            <?php } ?> ><?php echo ucfirst($boards->board_name); ?></option>
<?php } ?>
                                    </select>
                                    <div class="clear"></div>
                                    ...
                                    <div class="special" style="">
                                        <a href="javascript:void(0);" class="creat_bttn" id="board_creat_btn" onclick="addnewmenupin(<?php echo $user->id; ?>)" style="display:block">
    ...
    <div id="UploadPin" class="ModalContainer">
        <div class="modal wide" id="upload_pin_pic">
            ...
            <div class="PinTop">
                <form action="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boarddisplay'); ?>" id="imageform" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="upload_image_popup" style="display:none;">
                        <div id="upload_pin" style="display:none;">
                            ...
                            <ul class="img_upload">
                                <li>
                                    <select class="custom customStyleSelectBox" name="upload_board" id="upload_board"  onchange="changeselected(this)">
                                        <?php
                                        $boardid = 0;
                                        $i = 0;
                                        ...
                                        ?>
                                            <option value="<?php echo $board->board_id; ?>" <?php if (!empty($board->cuser_id)) { ?>
                                    class="edit-board_cont"
                            <?php } ?>> <?php echo $board->board_name; ?></option>
<?php } ?>
                                    </select>
...
<?php echo JText::_('MOD_SOCAILPINBOARD_MENU_CREATE'); ?>
    ...
    <div id="CreateBoard" class="ModalContainer">
        <div class="modal wide" style="margin-bottom: -80px !important;">
            ...
            <form id="boardfrm" action="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boarddisplay'); ?>" method="post" class="Form StaticForm noMargin">
                <ul>
                    <li class="noBorderTop">
                        <label><?php echo JText::_('MOD_SOCAILPINBOARD_MENU_BOARD_NAME'); ?></label>
                        <div class="floatright" style="width: 370px;">
                            <input id="board_name" type="text" name="board_name"  style="width: 374px;"/>
                            <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div id="CategoryPicker" class="BoardSelector BoardPickerselect">
                            <select name="board_category_id" id="board_category_id" class="custom customStyleSelectBox" style=" display: none; ">
...
<?php } ?>
            ...
            <div id="Repin" class="ModalContainer">
                <div class="modal wide PostSetup" style=" ">
                    <div id="postsetup">
                        <a href="#" class="close-btn_repin" onclick=" document.getElementById('descriptionerror').innerHTML='';document.getElementById('Header').style.zIndex = 999;Modal.close('Repin'); return false">X</a>
<!--                        <div class="header lg">
                            <h2><?php echo JText::_('COM_SOCIALPINBOARD_REPIN'); ?></h2>
                            <a href="#" class="close-btn" onclick=" document.getElementById('descriptionerror').innerHTML='';document.getElementById('Header').style.zIndex = 999;Modal.close('Repin'); return false"></a>
                        </div>-->
                        <div class="ImagePicker">
                            <div class="Images" id="imagepin"><img src="" name="pinImage" id="pinImage"></div>
                        </div>
                        <div class="PinForm">
                            <div class="select_board_name">
                                <select class="custom customStyleSelectBox" name="repin_board" id="repin_board">
                                    <?php foreach ($resultboards as $board) { ?>
                                                        <option class="BoardCategory" value=" <?php echo $board->board_id; ?>" <?php if (!empty($board->cuser_id)) { ?>
                                    class="edit-board_cont"
                            <?php } ?>> <?php echo $board->board_name;
                                                        ; ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <?php echo JText::_('MOD_SOCAILPINBOARD_MENU_CREATE'); ?>
                                ...
                                <div class="repin-text InputArea" style="float: left; ">
                                    <ul class="Form FancyForm">
...
<script src="components/com_socialpinboard/javascript/jScrollPane.js"></script>
<script src="components/com_socialpinboard/javascript/SelectBox.js"></script>
<script src="components/com_socialpinboard/javascript/jquery.mousewheel.js"></script>
				...
				scr("select.custom").each(function() {
						...
						width: 200
                                                ...
                                                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                                                {
                                                    ...
                                                    {  document.getElementById("menuSearchVal").innerHTML="";
                                                        ...
                                                        if(searchValue !='"no user"'){
                                                            ...
                                                            document.getElementById("menuSearchVal").innerHTML = '';
                                                            document.getElementById("menuSearchVal").innerHTML ="<?php echo JText::_('MOD_SOCIALPINBOARD_NO_USER_FOUND'); ?>";
                                                        }
                                ...
                                <script type="text/javascript" >
                                    ...
                                    function ajxGetBoards(baseurl){
                                        ...
                                        if(descriptions=='')
                                        {
                                            document.getElementById('descriptionerror').innerHTML='<label style="color:red">Describe your pin�</label>';
                                            return false;
                                        }
    ...
    ?>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function validateImageUrl()
                                    {
                                        ...
                                        if(str=='')
                                        {
                                            document.getElementById('addpinerror').innerHTML='<label id="login_error_msg" style="padding: 0px;display: block;clear: both;position: relative;margin: 0;text-align: left;top:-2px;"><?php echo JTEXT::_('MOD_SOCIALPINBOARD_MENU_IMAGE_DOESNOT_EXIST'); ?></label>';
                                            return false;
                                        }


                                        if(desc == ''|| desc=='<?php echo JText::_('MOD_SOCAILPINBOARD_MENU_PLEASE_ENTER_DESCRITION'); ?>'){
                                            document.getElementById('addpinerror').innerHTML='<label id="login_error_msg" style="padding: 0px;display: block;clear: both;position: relative;margin: 0;text-align: left;top:-2px;"><?php echo JTEXT::_('MOD_SOCAILPINBOARD_MENU_PLEASE_ENTER_THE_DESCRITION'); ?></label>';
                                            return false;
                                        }
                                ...
                                <script type="text/javascript">
                                    function loadXMLDoc()
                                    {
                                        ...
                                        else if (filename.indexOf('youtu.be') > -1) {
                                         var regExp = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/; //regular expression for youtube
                                         var match = filename.match(regExp);  // get the array value of the url
                                         youtubeId =  match[7];
                                         content = '<input type="hidden" name="type" id="type" value="youtube"/>';
                                                content += '<img id="youtubeimg" src="http://img.youtube.com/vi/' +youtubeId+'/0.jpg" width="198" height="150"/>';
                                                content += '<input type="hidden" name="youtube_image" id="youtube_image" value="http://img.youtube.com/vi/' +youtubeId+ '/0.jpg"/>';
                                                document.getElementById('ScrapePinInput').value="http://www.youtube.com/watch?v="+youtubeId;
                                                bindimage(content);
                                        }
...
<script>
    var Modal=Modal||{
        ...
        show:function(a){
            ...
            c.show();
            var d=a.outerHeight()-35;
            a.css("margin-bottom","-"+(d-60)/2+"px");
            setTimeout(function(){
                c.addClass("visible");
    ...
    function addplus_popup(){
    if(txt =='iPod'|| txt =='iPhone'|| txt =='Linux armv7l' || txt =='Linux armv6l')
    {
        document.getElementById('aboutMob').style.display = 'none';
        document.getElementById('addPlus').onclick = '';
        window.location.href='<?php echo JURI::base() . "index.php?option=com_socialpinboard&view=addplus" ?>';
    }else{
         document.getElementById('aboutMob').style.display = 'block';
    }
    }
