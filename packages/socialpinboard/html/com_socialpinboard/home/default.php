...
<script type="text/javascript">
           ...
           if(txt =='Win32'){
                  <?php $test="style=display:none;"; $facebox_class="facebox"; ?>
                }
                        </script>
<div id="container"  >
...
<!--                                <strong class="PriceContainer">
                        ...
                        ?>
                     <a id="pinnerdiv<?php echo $arrPins->pin_id;?>" href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $arrPins->pin_id); ?>" class="PinImage ImgLink <?php echo $facebox_class; ?>" >
                        <?php
                        if ($arrPins->link_type == 'youtube' || $arrPins->link_type == 'vimeo') {
                            ?>
...
?>
        ...
        echo '<label id="login_error_msg" style="display: block;">' . JText::_('COM_SOCIALPINBOARD_SORRY_NO_PINS') . '</label>';
    }
    ?>
</div>
<?php
