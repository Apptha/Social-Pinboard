...
//echo "<pre>";print_r($user_res);exit;
...
<?php }?>
        ...
        <div class="repins">
            ...
            <ul>
                <?php
                        foreach ($repinactivities as $test) {
                            $resultmodrepin = socialpinboardModellikes::getModRepinpinUserdetails($test->pin_repin_id);
            ...
            <div id="ContextBar" class="clearfix">
                ...
                <li>
                    <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=likes' . $userLink) ?>" class="selected">
                        <?php
                        if (count($pinLikes) > 1)
                ...
                ?>
                    ...
                    <?php
                                if ($users != $user->id && $users != '' && $user->id != '') {
                                    if (($followers == 'all') || ($totalBoards == $follwercount)) {
                    ?>
...
?>
    ...
    ?>
                        <div align="center" class="error message" id="login_error_msg" >
                            <img src="components/com_socialpinboard/images/nolikes.png">
                            <ul>
                                <li><h3 style="font-size: 24px;
                                        font-weight: 300;"><?php echo JText::_('COM_SOCIALPINBOARD_SORRY_NO_LIKES'); ?></h3></li>
                            </ul>
                        </div>
    ...
    ?>
            ...
            <?php
                            ...
                            if (preg_match('/MSIE/i', $u_agent)) {
                                if ($arrPins->link_type == 'youtube' || $arrPins->link_type == 'vimeo') {
            ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $arrPins->pin_id); ?>" class="PinImage ImgLink"   style="position: absolute;z-index: 1;top: 39%;left: 40%;"><img src="<?php echo JURI::base() . "components/com_socialpinboard/images/play_btn.png"; ?>" width="50" height="50" alt="" class="play_button" ></a>
<?php } ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $arrPins->pin_id); ?>" class="PinImage ImgLink"  ><img src="<?php echo $src_path; ?>" alt="" class="pin_pic_img_a">
                                </a>
            ...
            <?php
                                ...
                                if ($arrPins->link_type == 'youtube' || $arrPins->link_type == 'vimeo') {
            ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $arrPins->pin_id); ?>" class="PinImage ImgLink facebox" style="position: absolute;z-index: 1;top: 39%;left: 40%;"><img src="<?php echo JURI::base() . "components/com_socialpinboard/images/play_btn.png"; ?>" width="50" height="50" alt="" class="play_button" ></a>
<?php } ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=pin&pinid=' . $arrPins->pin_id); ?>" class="PinImage ImgLink"  rel="facebox" ><img src="<?php echo $src_path; ?>" alt="" class="pin_pic_img_a">
                                </a>
            <?php
                            }
            ?>
                ...
                ?>
                            ...
                            <div class="btn-pinlist btn-like" id="likebtn<?php echo $arrPins->pin_id; ?>">
                                ...
                                <input type="button" class="pin_like" onclick="this.disabled=true; (getlike(<?php echo $arrPins->pin_id; ?>,<?php echo $userid; ?>,<?php echo $flag = 0; ?>),disablelike(<?php echo $arrPins->pin_id; ?>,<?php echo $userid; ?>,<?php echo $flag = 0; ?>))" title="<?php echo JText::_('COM_SOCIALPINBOARD_LIKE'); ?>" id="like<?php echo $arrPins->pin_id; ?>" style="<?php echo $likestyle; ?>" value="<?php echo JText::_('COM_SOCIALPINBOARD_LIKE'); ?>" />
                                <input type="button" class="pin_unlike" onclick="this.disabled=true; (getlike(<?php echo $arrPins->pin_id; ?>,<?php echo $userid; ?>,<?php echo $flag = 1; ?>),disableunlike(<?php echo $arrPins->pin_id; ?>,<?php echo $userid; ?>,<?php echo $flag = 0; ?>))" title="<?php echo JText::_('COM_SOCIALPINBOARD_UNLIKE'); ?>" id="unlike<?php echo $arrPins->pin_id; ?>" style="<?php echo $unlikestyle; ?>" value="<?php echo JText::_('COM_SOCIALPINBOARD_UNLIKE'); ?>" />
                            </div>
                            <div class="btn-pinlist btn-comment">
                                <input type="button" onclick="comment(<?php echo $arrPins->pin_id; ?>,<?php echo $user->id; ?>)"  title="<?php echo JText::_('COM_SOCIALPINBOARD_COMMENT'); ?>" id="comment<?php echo $arrPins->pin_id; ?>"  value="<?php echo JText::_('COM_SOCIALPINBOARD_COMMENT'); ?>" />
                            </div>
                        </div>
                ...
                ?> </span>
                    ...
                    <div class="convo attribution clearfix">
                        <a href="<?php echo JRoute::_("index.php/component/socialpinboard/boarddisplay?uid=" . $arrPins->pin_user_id) ?>">
                ...
                ?>
                     ...
                     ?>
                           <img src="<?php echo JURI::Base(); ?>/components/com_socialpinboard/images/no_user.jpg" title="no_user" alt="<?php echo JText::_('COM_SOCIALPINBOARD_NO_USER'); ?>" height="30px" width="30px" class="ImgLink thumb-img " />
                <?php
                            }
                ?>

                        </a>
                        <div class="board_grid board_content">  <a href="<?php echo JRoute::_("index.php?option=com_socialpinboard&view=boarddisplay&uid=" . $arrPins->pin_user_id) ?>"><?php echo ucfirst($arrPins->first_name) . " " . ucfirst($arrPins->last_name); ?></a> onto <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boardpage&bId=' . $arrPins->pin_board_id); ?>" ><?php echo $arrPins->board_name; ?></a></div>
                ...
                ?>
                                        <li>
                                            <div class="comment clearfix">    <a href="<?php echo JRoute::_('index.php?option=com_socialpinboard&view=boarddisplay&uid=' . $comment->pin_user_comment_id); ?>">
                            ...
                            ?>
                                            <img height="30px" src="<?php echo JURI::base() . 'images/socialpinboard/avatars/' . $comment->user_image; ?>" title="<?php echo $arrPins->username; ?>" id='photoUrl'
                                                 alt="<?php echo $arrPins->username; ?>" width="30px" class="ImgLink thumb-img"/>
                                 <?php
                                        } else {
                                 ?>
                                       <img height="30px" src="<?php echo JURI::base() . 'components/com_socialpinboard/images/no_user.jpg' ?>" title="<?php echo $arrPins->username; ?>" id='photoUrl'
                                            alt="<?php echo $arrPins->username; ?>" width="30px" class="ImgLink thumb-img"/>
                                 <?php
                                        }
                                 ?>
...
<?php echo $comment->first_name . " " . $comment->last_name; ?>
                                    ...
                                    &nbsp;
                                    <span>
<?php echo $comment->pin_comment_text ?>
                                    </span>
                                </div>
                            </div> </li>
                <?php
                ...
                <div id="blogdisplay" class="ModalContainer">
                    <div class="modal wide PostSetup" id="blogdisplaymodal">
                        <div id="postsetup">
                            ...
                            <a class="closebutton"  onclick="javascript:document.getElementById('outputs').innerHTML = '';Modal.close('blogdisplay'); return false"></a>
...
$routerUrl=JRoute::_(JURI::base().'index.php?option=com_socialpinboard&amp;view=likes'.$querystring.'&amp;tmpl=component&amp;page=1');
?>
                <nav id="page-nav">
                ...
                <script>
                    ...
                    jQuery(document).ready(function($) {
                         scr('#CategoriesBarPage').css('height', '698px');
                        scr('a[rel*=facebox]').facebox({
    ...
    function enablecreate()
    {
        ...
        document.getElementById('CreateBoardhome').style.display='block';
    }
</script>
