...
<script type="text/javascript">
    ...
    var email_available="<?php echo JText::_('COM_SOCIALPINBOARD_EMAIL_AVAILABLE'); ?>";
    var username_available="<?php echo JText::_('COM_SOCIALPINBOARD_USERNAME_AVAILBALE'); ?>";
    var blocked_email="<?php echo JText::_('COM_SOCIALPINBOARD_BLOCKED_EMAIL_ID'); ?>";
    var username_not_available="<?php echo JText::_('COM_SOCIALPINBOARD_USERNAME_NOT_AVAILBALE'); ?>";
    var email_blocked="<?php echo JText::_('COM_SOCIALPINBOARD_EMAIL_BLOCKED'); ?>";
...
?>
        ...
        <ul>
            ...
            <div class="signup_left">
                    <li class="topborder_none li_right">
                ...
                <li>
                    ...
                    <li class="edit-add-pass li_right">
