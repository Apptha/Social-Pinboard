...
<!--                            </strong></strong>-->
                              <?php //} ?>
                  <?php }?>
                <img src="<?php echo $src_path; ?>" alt="" class="pin_pic_img_a" />
                      <?php if($arrPins->gift == '1'){?> <strong class="PriceContainer"><strong class="price"><?php echo $getCurrencySymbol.$arrPins->price;?></strong></strong><?php } ?>
            </a>
           <?php
        }
...
<nav id="page-nav" style="display:none;">
    <a style="display:none;" id="navpage" href="<?php echo $this->baseurl ?>/index.php/component/socialpinboard/?view=video&page=1"></a>
</nav>
    <script>
                       ...
                       scr.ajax({
                           ...
                           success:function(message) {
                               ...
                               if(message != "error") {
                                   ...
                                   message1 += '<div class="board_content"><span><a href="'+userUrl+'">'+firstName+' '+lastName+'</a>';
