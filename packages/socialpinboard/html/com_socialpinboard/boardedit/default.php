 ...
 * @abstract      : Social Pinboard Component Board edit view
    ...
    ?>
        ...
        <div class="static-form clearfix" id="form_contributes">
            ...
            <div class="board_edit_wrapper_right">
                <ul>
                    <li>
                        <?php $enter_email = JText::_('COM_SOCIALPINBOARD_NAME_OR_EMAIL_ADDRESS'); ?>
                        <input type="text" name="name_contributer" id="name_contributer" autocomplete="off" style="color: #C9C8C8" value="<?php echo JText::_('COM_SOCIALPINBOARD_NAME_OR_EMAIL_ADDRESS'); ?>" onFocus='onFocusEvent(this,"<?php echo htmlentities(JText::_('COM_SOCIALPINBOARD_NAME_OR_EMAIL_ADDRESS'), ENT_QUOTES); ?>");' onBlur='onBlurEvent(this,"<?php echo htmlentities(JText::_('COM_SOCIALPINBOARD_NAME_OR_EMAIL_ADDRESS'), ENT_QUOTES); ?>");'  onkeyup="showSearchResult(this.value);"/>
...
if(searchValue=='"no user"'){
    b+="<li id='static_li' style='padding-left:5px;' ><?php echo JText::_('COM_SOCIALPINBOARD_NO_USER_FOUND'); ?></li>";
}else{
...
function userContributer(img_link,bidd)
    {    
        ...
        if(user_contributers!='Username not exist'){
                    ...
                    content = '<img src="'+imagelink+'" class="avatar" /> <a href="" class="contributer_new_name">'+name_contributers.replace('%20', ' ')+' '+'</a><a href="javascript:void(0)" class="contributer_new_name_remove" onclick="remove_contributers('+contributer_details[1]+','+bidd+');" ></a>';
