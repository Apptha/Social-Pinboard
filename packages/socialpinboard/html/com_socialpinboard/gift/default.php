 ...
 * @abstract      : Social Pinboard Component Gift view
...
<div id="container" <?php if (count($pins) == 0) { echo 'class="no_pins"'; } ?> >
        <?php
    if (count($pins) != 0) {
...
<!--                                </strong></strong>-->
                       ...
                       <?php if ($arrPins->link_type == 'youtube'  || $arrPins->link_type == 'vimeo') {
                            ?>
                            ...
                            foreach ($comment_res as $comment) {
                                if ($i < 6) {
                                    ...
                                    if ($comment->user_image == '') {
                                        ?>
                                                    <img height="30" src="<?php echo JURI::base() . 'components/com_socialpinboard/images/no_user.jpg' . $comment->user_image; ?>" title="<?php echo $comment->username; ?>" id='photoUrl'
            ...
            ?>
                    ...
                    <div class="clear"></div>
                            ...
                            ?>
                             ...
                             {
                                 echo '<label id="login_error_msg" style="display: block;">'.JText::_('COM_SOCIALPINBOARD_SORRY_NO_GIFTS').'</label>';
                             }
                             ?>
...
?>
             <nav id="page-nav" style="display:none;">
                 <a style="display:none;" id="navpage" href="<?php echo $this->baseurl ?>/index.php/component/socialpinboard/?view=gift<?php echo $querystring; ?>&page=1"></a>
</nav>
           ...
           scr.ajax({
                ...
                success:function(message) {
                    ...
                    if(message != "error") {
                        ...
                        message1 += '<p class="board_content board_grid"><a href="'+userUrl+'">'+firstName+' '+lastName+'</a>';
